...
A Figura~\ref{fig:typicallimit} mostra um limite típico. Observando-se o
...
Na Figura~\ref{fig:inexistentlimit}, parte da curva com $x \approx c$
...
\begin{figure}
\begin{center}
\subfigure[fig:typicallimit][$\displaystyle \lim_{x \to c} f(x) = L$]%
	{\includegraphics{typicallimit}}

\subfigure[fig:inexistentlimit][Limite inexistente]%
