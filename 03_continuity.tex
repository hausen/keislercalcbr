...
\begin{example}
  Determine $\displaystyle \lim_{x \to 2} \frac{x^2 + 3x - 10}{x^2 - 4}$.
  \begin{stepanalysis}
  \item Desta vez, o termo dentro do limite é indefinido quando $x = 2$.
        Tomando $x \approx 2$ mas $x \ne 2$, temos
        $$
  ...
  \item $\displaystyle \st{\frac{x^2 + 3x - 10}{x^2 - 4}} =
        ...
        Portanto, \hspace{1.5em} $\displaystyle \lim_{x \to 2}
          \left(\frac{x^2 + 3x - 10}{x^2 - 4}\right) = \frac{7}{4}$.
  \end{stepanalysis}
\end{example}
