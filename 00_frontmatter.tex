...
foram compilados em uma única seção ao final do Capítulo 3. O
desenvolvimento da integral no Capítulo 4 foi simplificado. A 
%% TODO: "regra do trapézio"?
Regra do Trapézio foi trazida do Capítulo 5 para o Capítulo 4, e
uma discussão sobre a Regra de Simpson foi adicionada. A seção sobre a
área entre duas curvas foi transferida do Capítulo 6 para o Capítulo 4.
...
Apenas pequenas mudanças e correções foram feitas nos Capítulos de 7
